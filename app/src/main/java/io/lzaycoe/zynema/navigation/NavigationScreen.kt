...
sealed class Screen(
  ...
  data object PopularCelebritiesNav :
      Screen(
          "popular_celebrities",
          title = R.string.popular,
          navIcon = {
  ...
  data object TrendingCelebritiesNav :
      Screen(
  ...
  data object FavoriteMovie : Screen("favorite_movie")

  data object FavoriteTvSeries : Screen("favorite_tv_series")
}
