...
import io.lzaycoe.zynema.data.model.tv_series_detail.CreatedBy
import io.lzaycoe.zynema.data.model.tv_series_detail.Genre
import io.lzaycoe.zynema.data.model.tv_series_detail.LastEpisodeToAir
import io.lzaycoe.zynema.data.model.tv_series_detail.Network
import io.lzaycoe.zynema.data.model.tv_series_detail.NextEpisodeToAir
import io.lzaycoe.zynema.data.model.tv_series_detail.ProductionCompany
import io.lzaycoe.zynema.data.model.tv_series_detail.ProductionCountry
import io.lzaycoe.zynema.data.model.tv_series_detail.Season
import io.lzaycoe.zynema.data.model.tv_series_detail.SpokenLanguage

class TvSeriesTypeConverter {
  private val gson: Gson by lazy { Gson() }

  @TypeConverter fun fromCreatedByList(value: List<CreatedBy>): String = gson.toJson(value)

  @TypeConverter
  fun toCreatedByList(value: String): List<CreatedBy> =
      gson.fromJson(value, object : TypeToken<List<CreatedBy>>() {}.type)

  @TypeConverter fun fromEpisodeRunTimeList(value: List<Int>): String = gson.toJson(value)
  ...
  @TypeConverter fun fromLanguagesList(value: List<String>): String = gson.toJson(value)

  @TypeConverter
  fun toLanguagesList(value: String): List<String> =
      gson.fromJson(value, object : TypeToken<List<String>>() {}.type)

  @TypeConverter fun fromLastEpisodeToAir(value: LastEpisodeToAir?): String = gson.toJson(value)

  @TypeConverter
  fun toLastEpisodeToAir(value: String): LastEpisodeToAir? =
      gson.fromJson(value, LastEpisodeToAir::class.java)

  @TypeConverter fun fromNetworksList(value: List<Network>): String = gson.toJson(value)

  @TypeConverter
  fun toNetworksList(value: String): List<Network> =
      gson.fromJson(value, object : TypeToken<List<Network>>() {}.type)

  @TypeConverter fun fromNextEpisodeToAir(value: NextEpisodeToAir?): String = gson.toJson(value)
  ...
  @TypeConverter fun fromSeasonsList(value: List<Season>): String = gson.toJson(value)
