...
interface ApiService {
  ...
  @GET("movie/{movieId}") suspend fun movieDetail(@Path("movieId") movieId: Int): MovieDetail
  ...
  @GET("movie/{movieId}/credits") suspend fun movieCredit(@Path("movieId") movieId: Int): Artist

  @GET("person/{personId}") suspend fun artistDetail(@Path("personId") personId: Int): ArtistDetail
  ...
  @GET("tv/{seriesId}") suspend fun tvSeriesDetail(@Path("seriesId") seriesId: Int): TvSeriesDetail

  @GET("tv/{seriesId}/recommendations")
  suspend fun recommendedTvSeries(@Path("seriesId") seriesId: Int): BaseModel<TvSeriesItem>

  @GET("tv/{seriesId}/credits") suspend fun tvSeriesCredit(@Path("seriesId") seriesId: Int): Artist
